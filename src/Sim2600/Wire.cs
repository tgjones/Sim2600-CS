...
{
    public const byte PULLED_HIGH = 1 << 0;   // 1
    public const byte PULLED_LOW = 1 << 1;    // 2
    public const byte FLOATING_HIGH = 1 << 4; // 16
    public const byte FLOATING_LOW = 1 << 5;  // 32
    public const byte FLOATING = 1 << 6;      // 64
